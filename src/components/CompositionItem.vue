<template>
		<div class="border border-gray-200 p-3 mb-4 rounded">
              ...
              <div v-show="showForm">
				<div class="text-white text-center font-bold p-4 mb-4" v-if="show_alert" :class="alert_varient">
				  {{ alert_message }}
			  </div>
...
export default {
	...
	data(){
		return {
			...
			alert_message: 'Please wait, the song information is being updated',
		};
	},
	methods: {
		async edit(values) {
		...
		this.alert_message = 'Please wait, the song information is being updated';
		try{
